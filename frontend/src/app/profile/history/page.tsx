    ...
    return (
        <main className="min-h-screen bg-background relative overflow-hidden">
            ...
            <div className="absolute inset-0 pointer-events-none">
                ...
                <div className="absolute top-0 right-1/4 w-96 h-96 bg-purple-500/10 rounded-full mix-blend-screen filter blur-3xl opacity-50 animate-blob animation-delay-2000"></div>
            </div>
            ...
            <div className="relative py-12 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto z-10">
                <div className="mb-8">
                    <h1 className="text-3xl font-bold text-white">Exam History</h1>
                    <p className="text-gray-400 mt-2">View all your past exams and results</p>
                </div>

                <HistoryClient userId={(session.user as any)?.id} />
            </div>
        </main>
    );
}
